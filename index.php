                ...
                <div class="row">
                    <div class="col-md-5 col-md-push-7">
                        <div class="banner_content">
                            ...
                            <p>Chúng tôi có rất nhiều lựa chọn cho bạn.</p>
    ...
    <section class="section-padding gray-bg">
        <div class="container">
            <div class="section-header text-center">
                ...
                <p>Thuexe là một Startup tiên phong trong việc phát triển nền tảng trực tuyến cho thuê và chia sẻ xe tự
                    lái ở Việt Nam.
                    Thuexe giúp khách hàng có nhu cầu thuê xe tự lái (ô tô, xe máy) có thể kết nối với các đơn vị cho
                    thuê xe cũng như cá nhân có xe nhàn rỗi trên khắp cả nước thông qua website hoặc ứng dụng di động.
                    Khách hàng có thể tìm kiếm, so sánh và thuê xe một cách dễ dàng, nhanh chóng.
                    Thuexe được ra đời với sứ mệnh mang đến nền tảng công nghệ hiện đại giúp việc thuê và chia sẻ xe một
                    cách Nhanh chóng, An toàn và Tiết kiệm. Thuexe hướng tới một cộng đồng cho thuê và chia sẻ phương
                    tiện đi lại một cách văn minh và thân thiện với môi trường.</p>
            </div>
            <div class="row">
    ...
    <section class="section-padding testimonial-section parallex-bg">
        <div class="container div_zindex">
            <div class="section-header white-text text-center">
                <h2>Đánh giá của khách hàng <span>Về chúng tôi</span></h2>
            </div>
            <div class="row">
